...
public class StatementFactory {
    ...
    Statement[] statements = {
            ...
            new Statement("SELECT name FROM pokemons WHERE primary_type = 'normal'", false),
            ...
            //Ottenimento Pokemon
            new Statement("SELECT name, primary_type FROM pokemons WHERE name = 'JUST_INVENTED'", false),
            ...
            new Statement("SELECT first_name, last_name FROM trainers WHERE username = (" +
                    "SELECT trainer FROM pokemon_trainer " +
                    "GROUP BY trainer ORDER BY COUNT(*) DESC LIMIT 1)", false),
